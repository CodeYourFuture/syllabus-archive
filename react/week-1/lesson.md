...
> **Exercise C**: If you haven't already, [follow the instructions to create a React app named `pokedex`](https://docs.codeyourfuture.io/students/guides/creating-a-react-app).
