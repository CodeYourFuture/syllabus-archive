...
1. Fork [this repository](https://github.com/Code-Your-Future/html-css-project) and follow the instructions on the README. If you need help with Forking - then refer back to [this tutorial](https://help.github.com/articles/fork-a-repo/)
