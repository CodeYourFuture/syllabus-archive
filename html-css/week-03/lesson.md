...
1. **Components** define re-usable code snippets for common requirements, like navigation menus.
1. **Helpers** define additional code tools to construct the site, like layout grids
